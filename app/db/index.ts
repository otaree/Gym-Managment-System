...
import { IMemberPayment, IMemberPaymentDocument } from './model/memberPayment';
import memberPayment, { IMemberPaymentQuery } from './method/memberPayment';
...
export default (appPath: string) => {
  return {
    ...
    sale: sale(appPath),
    memberPayment: memberPayment(appPath),
  };
};
